  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setIsSubmitting(false); // Reset to allow resubmission
      } else {
        console.log('Something went wrong. Please try again.');
      }
    } catch (error) {
                ...
                <div>
                  ...
                  <form className="mt-12 space-y-6" onSubmit={handleSubmit}>
                    {[
                      ...
                      <div key={name} className="flex flex-col gap-[6px]">
                        ...
                        <input
                          ...
                          type={type}
                          className={`input-style input-focus ${
                            errors[name as keyof FormErrors] ? '!border-[1px] !border-red-500' : ''
                          }`}
                          placeholder={placeholder}
                    ...
                    <div className="flex flex-col gap-[6px]">
                      ...
                      <div className={`flex w-full items-center justify-between rounded-[8px] border-[1px] border-[#D0D5DD] ${
                        errors.phone ? 'border-red-500' : ''
                      }`}>
                        <p className="input-label-currency border-r-[1px] border-[#D0D5DD] px-[14px]">+88</p>
                        <input
